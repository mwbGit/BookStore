...
<head>
	...
	<link href="../static/media/css/error.css" rel="stylesheet" type="text/css"/>
...
<body class="page-404-3">
	...
	<div class="page-inner">
		...
		<img src="../static/media/image/earth.jpg" alt="">
	...
	<script src="../static/media/js/jquery-1.8.3.min.js" type="text/javascript"></script>
