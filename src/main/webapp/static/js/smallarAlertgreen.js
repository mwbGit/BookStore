...
;(function($) {
	$.MsgBox = function(options) {
		...
		function pageRender(type, title, msg) { /** 渲染页面**/
			...
			html += '<a id="msg_ico">x</a><div id="msg_msg"> <strong ><h4 align="center" style="font-size:20px;">' + msg + ' </h4></strong></div><div id="msg_btnbox">';
			if (type == "alert") {
