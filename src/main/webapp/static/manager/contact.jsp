      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="getMessage">留言管理</a></li>
        ...
        <div class="span12">
          <div class="portlet box green">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"><i class="icon-globe"></i>留言详情</div>
            ...
            <div class="portlet-body">
              <table class="table table-striped table-hover table-bordered"
                ...
                <tr>
                  ...
                  <th class="hidden-480" width="45%">内容</th>
                ...
                <c:forEach items="${requestScope.contacts}" var="Contact">
                  <tr>
                    ...
                    <td><a class="delete" href="deleteMessage?id=${Contact.id}">删除</a></td>
                  </tr>
                </c:forEach>
                </tbody>
