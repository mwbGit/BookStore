                ...
                <div class="span12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption"><i class="icon-globe"></i>待发货详情</div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                                ...
                                <c:forEach items="${requestScope.oders}" var="Oder">
                                    <tr>
                                        ...
                                        <td>${Oder.adress}</td>
                                        <td>${Oder.tel}</td>
                                        <td><a class="send" href="OderSend?id=${Oder.id}">发货</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script src="media/js/odershow.js"></script>
