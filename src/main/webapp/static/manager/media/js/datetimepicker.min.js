!function (t) {
    ...
    n.prototype = {
        constructor: n, init: function (e, i) {
            var a;
            ...
            var e = this.viewDate.getUTCFullYear(), i = this.viewDate.getUTCMonth(), s = a(this._date.getUTCFullYear(), this._date.getUTCMonth(), this._date.getUTCDate(), 0, 0, 0, 0), n = "object" == typeof this.startDate ? this.startDate.getUTCFullYear() : -1 / 0, o = "object" == typeof this.startDate ? this.startDate.getUTCMonth() : -1, d = "object" == typeof this.endDate ? this.endDate.getUTCFullYear() : 1 / 0, h = "object" == typeof this.endDate ? this.endDate.getUTCMonth() : 12;
            ...
            var c = a(e, i - 1, 28, 0, 0, 0, 0), l = u.getDaysInMonth(c.getUTCFullYear(), c.getUTCMonth());
            ...
            var w = this._date.getUTCFullYear(), v = this.widget.find(".datepicker-months").find("th:eq(1)").text(e).end().find("span").removeClass("active");
            ...
            t.parent().hide();
            var e = "";
            if (this.options.pick12HourFormat)for (var s = 1, a = 0; 3 > a; a += 1) {
                e += "<tr>";
                for (var n = 0; 4 > n; n += 1) {
                    var o = s.toString();
            ...
            if (this._date) {
                var t = this.widget.find(".timepicker span[data-time-component]"), e = (t.closest("table"), this.options.pick12HourFormat), s = this._date.getUTCHours(), a = "AM";
                e && (s >= 12 && (a = "PM"), 0 === s ? s = 12 : 12 != s && (s %= 12), this.widget.find(".timepicker [data-action=togglePeriod]").text(a)), s = i(s.toString(), 2, "0");
                var n = i(this._date.getUTCMinutes().toString(), 2, "0"), o = i(this._date.getUTCSeconds().toString(), 2, "0");
            ...
            if (1 === i.length && !i.is(".disabled"))switch (i[0].nodeName.toLowerCase()) {
                case"th":
                    switch (i[0].className) {
                        ...
                        case"prev":
                        case"next":
                            var s = this.viewDate, n = u.modes[this.viewMode].navFnc, o = u.modes[this.viewMode].navStep;
                ...
                case"td":
                    if (i.is(".day")) {
                        var h = parseInt(i.text(), 10) || 1, r = this.viewDate.getUTCMonth(), d = this.viewDate.getUTCFullYear();
            ...
            incrementHours: function () {
                ...
                var i = t(e.target), s = parseInt(i.text(), 10);
            ...
            var i = t(e.currentTarget).data("action"), s = this.actions[i].apply(this, arguments);
            return this.set(), this.fillTime(), this.notifyChange(), s
        }, stopEvent: function (t) {
            t.stopPropagation(), t.preventDefault()
        }, keydown: function (e) {
            var i = this, s = e.which, a = t(e.target);
            ...
            var i = e.which;
            if (8 != i && 46 != i) {
                var s = t(e.target), a = String.fromCharCode(i), n = s.val() || "";
                n += a;
                var o = this._mask[this._maskPos];
                if (!o)return !1;
                if (o.end == n.length) {
                    if (!o.pattern.test(n.slice(o.start))) {
                        for (n = n.slice(0, n.length - 1); (o = this._mask[this._maskPos]) && o.character;)n += o.character, this._maskPos++;
            ...
            return this.format.replace(p, function (e) {
                ...
                if ("ms" === e && (o = 1), a = d[e].property, "Hours12" === a)n = t.getUTCHours(), 0 === n ? n = 12 : 12 !== n && (n %= 12); else {
            ...
            this.widget.on("click", ".datepicker *", t.proxy(this.click, this)), this.widget.on("click", "[data-action]", t.proxy(this.doAction, this)), this.widget.on("mousedown", t.proxy(this.stopEvent, this)), this.pickDate && this.pickTime && this.widget.on("click.togglePicker", ".accordion-toggle", function (i) {
                i.stopPropagation();
                var s = t(this), a = s.closest("ul"), n = a.find(".collapse.in"), o = a.find(".collapse:not(.in)");
                if (n && n.length) {
    ...
    var o = 0, r = t.fn.datetimepicker.dates = {
        en: {
