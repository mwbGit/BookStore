			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input name="name" class="m-wrap placeholder-no-fix" type="text" placeholder="Username" name="username"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input name="password" class="m-wrap placeholder-no-fix" type="password" placeholder="Password" name="password"
